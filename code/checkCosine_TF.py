...
def _tfGetTargetList():

	targetInstances = []
	with open('../input/gsrData.pickle', 'rb') as handle:
  		targetInstances = pickle.load(handle)
...
def findCosineScore(matrix):
	...
	targetVec_List = _tfGetTargetList()
